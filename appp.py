...
st.markdown("**Enter mushroom features to predict if it's edible or poisonous**")

user_input = {}

for feature in features:
    options = feature_options[feature]
    selected = st.selectbox(f"{feature.replace('_', ' ').title()}:", options)
